            ...
            <nav className={`sticky top-0 z-50 w-full transition-all duration-500 ${
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16 md:h-18">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <button
                            onClick={toggleTheme}
                            className="theme-toggle-icon w-9 h-9 rounded-xl flex items-center justify-center transition-all hover:bg-[var(--input-bg)] text-theme-secondary hover:text-theme-primary"
