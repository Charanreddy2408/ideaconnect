                    ...
                    {error && (
                        ...
                        >
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <button type="button" className="py-3 rounded-xl bg-[var(--input-bg)] border border-[var(--input-border)] text-theme-secondary font-bold text-xs hover:bg-[var(--surface-hover)] transition-all flex items-center justify-center gap-2">
