                                ...
                                <div className="space-y-3">
                                    ...
                                    <p className="text-white/70 text-sm lg:text-base leading-relaxed font-medium">
                                        {isLogin 
                                            ...
                                            : "Join 1,200+ founders and builders creating the future together."}
                                    </p>
                                </div>
                        ...
                        >
                            <div className={`w-full max-w-sm space-y-6 transition-all duration-400 ${animating ? 'opacity-0 scale-95' : 'opacity-100 scale-100'}`}>
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4">
                                    ...
                                    <div className="space-y-1.5">
                                        <label className="text-xs font-bold text-theme-secondary ml-1 uppercase tracking-wider">Password</label>
                                        <input
                                            type="password"
                                            value={password}
